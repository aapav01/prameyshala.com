...
export default function GenerateInvoicePDF({ paymentData }: Props) {
  const handleGenerateInvoice = async () => {
    ...
    const { user, amount, createdAt, orderGatewayId, status, standard } = paymentData;
    ...
    // Footer
    drawText("If you have any questions concerning this invoice, Write us at prameyshala@gmail.com", 50, 50);
