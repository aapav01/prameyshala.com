...
export default async function Image() {
  return new ImageResponse(
    (
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" height={128} fill="white" viewBox="0 0 148 24.9">
        ...
        <svg viewBox="0 0 28 28" fill="none" style={{ position: 'absolute', top: '13%', right: '22%' }} xmlns="http://www.w3.org/2000/svg">
          <path
            d="M16.5961 10.265L19 1.33069L10.0022 3.73285L1 6.1306L7.59393 12.6627L14.1879 19.1992L16.5961 10.265Z"
            stroke="#1FB3FF"
            strokeWidth="2"
        ...
        <svg viewBox="0 0 28 28" fill="none" style={{ position: 'absolute', top: '8%', right: '22%' }} xmlns="http://www.w3.org/2000/svg">
          <path
            d="M16.5961 10.265L19 1.33069L10.0022 3.73285L1 6.1306L7.59393 12.6627L14.1879 19.1992L16.5961 10.265Z"
            stroke="#F1138F"
            strokeWidth="2"
        ...
        <svg viewBox="0 0 28 28" height={1000} fill="none" style={{ position: 'absolute', bottom: '-50%', left: '-20%', zIndex: -10, opacity: 0.2 }} xmlns="http://www.w3.org/2000/svg">
          <path
            d="M14 1C7.37258 1 1.99999 6.37258 1.99999 13C1.99999 19.6274 7.37258 25 14 25C20.6274 25 26 19.6274 26 13C26 6.37258 20.6274 1 14 1Z"
            fill="url(#paint0)"
          />
