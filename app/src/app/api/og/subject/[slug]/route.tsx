    ...
    (
      ...
      >
        ...
        >
          ...
          <path
            fillOpacity={0.7}
            d="M111.6,7.9c.7,.4,1.3,1,1.7,1.7s.6,1.7,.6,2.8v6.9h-1.9v-6.6c0-1.2-.3-2.1-.9-2.7-.6-.6-1.4-.9-2.4-.9s-1.8,.3-2.5,1-.9,1.6-.9,2.8v6.5h-2V3.4h2v5.8c.4-.6,.9-1.1,1.6-1.4,.7-.3,1.4-.5,2.3-.5s1.7,.2,2.4,.6h0Z"
          />
          <path
            fillOpacity={0.7}
        ...
        <span style={{ marginTop: "28px", textTransform: "capitalize" }}>
        ...
        >
          {data.subject.name} of {data.subject.standard.name}
        </span>
        <svg
          viewBox="0 0 28 28"
          fill="none"
        ...
        <svg
          viewBox="0 0 28 28"
          fill="none"
          style={{ position: "absolute", top: "6%", right: "22%" }}
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            d="M16.5961 10.265L19 1.33069L10.0022 3.73285L1 6.1306L7.59393 12.6627L14.1879 19.1992L16.5961 10.265Z"
        ...
        <svg
          ...
          height={500}
          fill="none"
          style={{ position: "absolute", top: "0%", right: "5%", opacity: 0.2 }}
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
          ...
          <defs>
            <radialGradient
              ...
              gradientTransform="translate(14 13) rotate(90) scale(13.5 13.5)"
            >
        ...
        >
          ...
          <defs>
            <radialGradient
              ...
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(14 13) rotate(90) scale(15 15)"
            >
              <stop stopColor="#1799ff" />
              <stop offset="1" stopColor="transparent" />
            </radialGradient>
