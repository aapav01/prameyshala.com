...
class Query(graphene.ObjectType):
    ...
    #quiz hash
    quiz_hash = graphene.Field(QuizHashType,quiz_id=graphene.ID(required=True))
    #quiz hash question answer
    quiz_hash_question_answer = graphene.Field(QuizHashQuestionAnswerType,quiz_hash_id=graphene.ID(required=True))
